package fr.emile.ebusiness.entity;
...
//	private String expiryDate ; 
	...
	public String toString() {
		...
		String result = String.format("BC(%d) %s %s ", this.getId(), this.getBelongTo(), this.getCardNumber());
		...
		result += String.format("[%s] {%s,%s}  userId : %d", 
				this.getCrypto(), this.getIsValid() ? "Valid" : "inValid",
				this.getIsDeleted() ? "deleted" : "in use", this.getUserId());
